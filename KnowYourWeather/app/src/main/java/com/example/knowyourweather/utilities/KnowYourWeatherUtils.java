 ...
 */
public class KnowYourWeatherUtils {
    private static final String LOG_TAG = KnowYourWeatherUtils.class.getSimpleName();
    ...
    public static String formatTemperature(Context context, double temperature) {
        ...
        if (!KnowYourWeatherPreferences.isMetric(context)) {
