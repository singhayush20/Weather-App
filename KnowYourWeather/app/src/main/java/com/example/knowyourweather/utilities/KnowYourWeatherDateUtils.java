...
/**
 * Class for handling date conversions that are useful for KnowYourWeather.
 */
public final class KnowYourWeatherDateUtils {
     ...
     *
     * Normalize, in our usage within KnowYourWeather means to convert a given date in milliseconds to
