...
public class WeatherProvider extends ContentProvider {
    ...
    {
        Log.i(TAG+"###","entered the buildUriMatcher() method in WeatherProvider class\n");
        /*
         ...
         * they aren't going to change. In KnowYourWeather, we use CODE_WEATHER or CODE_WEATHER_WITH_DATE.
         */
        /* This URI is content://com.example.knowyourweather/weather/ */
        matcher.addURI(authority, WeatherContract.PATH_WEATHER, CODE_WEATHER);
        /*
         * This URI would look something like content://com.example.knowyourweather/weather/1472214172
         * The "/#" signifies to the UriMatcher that if PATH_WEATHER is followed by ANY number,
         * that it should return the CODE_WEATHER_WITH_DATE code
         */
        matcher.addURI(authority, WeatherContract.PATH_WEATHER + "/#", CODE_WEATHER_WITH_DATE);
        Log.i(TAG+"###","returning from the buildUriMatcher() method\n");
        return matcher;
    }
    @Override
    ...
    public int bulkInsert(@NonNull Uri uri, @NonNull ContentValues[] values) {
        ...
        Log.i(TAG+" ###","entered the bulkInsert() method values.length: "+values.length);
            ...
            case CODE_WEATHER:
                ...
                try {
                    for (ContentValues value : values) {
                        ...
                        if (!KnowYourWeatherDateUtils.isDateNormalized(weatherDate)) {
                ...
                Log.i(TAG+" ###","returning rows inserted: "+rowsInserted);
                return rowsInserted;
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        Cursor cursor;
        Log.i(TAG+" ###","entered the query() method");
        /*
        ...
        Log.i(TAG+" ###","returning cursor from query()");
        return cursor;
    }


    /**
     * In KnowYourWeather, we aren't going to do anything with this method. However, we are required to
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) {
        throw new RuntimeException(
                "We are not implementing insert in KnowYourWeather. Use bulkInsert instead");
    }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String s, @Nullable String[] strings) {
        throw new RuntimeException("We are not implementing update in KnowYourWeather");
    }
