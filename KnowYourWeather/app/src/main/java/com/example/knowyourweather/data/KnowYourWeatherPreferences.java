...
public final class KnowYourWeatherPreferences {
    ...
    private static final String TAG = KnowYourWeatherPreferences.class.getSimpleName();
    ...
    public static void setLocationDetails(Context context, double lat, double lon) {
        Log.i(TAG+" ###","setting Location details in setLocationDetails: lat: "+lat+" long: "+lon);
    ...
    public static void resetLocationCoordinates(Context context) {
        Log.i(TAG+" ###","reseting the location coordinates");
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sp.edit();
    ...
    /**
     * Return true if the user prefers to see notifications from,
     * KnowYourWeather App, false otherwise. This preference  can be changed
     * by the user within the SettingsFragment.
     *
     * @param context: Used to access SharedPreferences
    ...
    {
        Log.i(TAG+" ###","entered the areNotificationsEnabled()");
        /*
        Key for accessing the preference for showing notifications
         */
        String displayNotificationsKey=context.getString(R.string.pref_enable_notifications_key);
        /*
         * In KnowYourWeather, the user has the ability to say whether she would like notifications
        ...
        //Use the defaultSharedPreferences to get the user's preferences
        SharedPreferences sp=PreferenceManager.getDefaultSharedPreferences(context);
        ...
        Log.i(TAG+" ###","returning shouldDisplayNotifications: "+shouldDisplayNotifications);
    ...
    public static long getLastNotificationTimeInMillis(Context context) {
        /* Key for accessing the time at which KnowYourWeather last displayed a notification */
    ...
    public static long getEllapsedTimeSinceLastNotification(Context context) {
        Log.i(TAG+" ###","entered getElapsedTimeSinceNotification()");
        long lastNotificationTimeMillis =
                KnowYourWeatherPreferences.getLastNotificationTimeInMillis(context);
        long timeSinceLastNotification = System.currentTimeMillis() - lastNotificationTimeMillis;
        Log.i(TAG+" ###","returning timeSinceLastNotification from getElapsedTimeSinceNotification(): "+timeSinceLastNotification);
    ...
    public static void saveLastNotificationTime(Context context, long timeOfNotification) {
        Log.i(TAG+" ###","in saveLastNotificationTime, timeOfLastNotification: "+timeOfNotification);
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sp.edit();
        String lastNotificationKey = context.getString(R.string.pref_last_notification);
        editor.putLong(lastNotificationKey, timeOfNotification);
        editor.apply();
        Log.i(TAG+" ###","returning from saveLastNotificationTime: ");
    }
