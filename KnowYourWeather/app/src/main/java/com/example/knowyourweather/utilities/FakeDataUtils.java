...
import static com.example.knowyourweather.data.WeatherContract.WeatherEntry;
...
public class FakeDataUtils {
    ...
    public static void insertFakeData(Context context) {
        ...
        long today = KnowYourWeatherDateUtils.normalizeDate(System.currentTimeMillis());
        ...
        // Bulk Insert our new weather data into KnowYourWeather's Database
